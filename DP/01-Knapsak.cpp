...
int spaceOp(vector<int>& weight,int n, vector<int>& value, int capacity){
...
int moreSpaceOp(vector<int>& weight,int n, vector<int>& value, int capacity){
		vector<int> curr(capacity+1,0);
...
int knapsack(vector<int> weight, vector<int> value, int n, int maxWeight) 
{
	...
	// return spaceOp(weight,n,value,maxWeight);

	return moreSpaceOp(weight,n,value,maxWeight);
